...
export async function loginAsDemo(page: Page, pathname = '/') {
  ...
  // always navigate directly to /home/vin-lookup to bypass any onboarding redirects
  // this is more reliable for CI testing than trying to click skip buttons
  console.info('Navigating to /home/vin-lookup...')
  await page.goto(`${BASE_URL}/home/vin-lookup`, { waitUntil: 'domcontentloaded' })

  // wait for page to stabilize
  await page.waitForTimeout(2000)

  // navigate to desired pathname if different from home/vin-lookup
  if (pathname !== '/' && pathname !== '/home' && pathname !== '/home/vin-lookup') {
